...
public MyFinishObject(String case_id, String case_No, String car_No,
		...
		String loss_price, String yard_time, String dingsun_price,
		String waixiu_state, String audit_state, String loss_state,
...
public String getDingsun_price() {
	return dingsun_price;
}

public void setDingsun_price(String dingsun_price) {
	this.dingsun_price = dingsun_price;
}

public String getWaixiu_state() {
	return waixiu_state;
}

public void setWaixiu_state(String waixiu_state) {
	this.waixiu_state = waixiu_state;
}
...
public String getRepair_parts() {
	return repair_parts;
}

public void setRepair_parts(String repair_parts) {
	this.repair_parts = repair_parts;
}
...
public String getLossStartTimeStamp() {
	return lossStartTimeStamp;
}

public void setLossStartTimeStamp(String lossStartTimeStamp) {
	this.lossStartTimeStamp = lossStartTimeStamp;
}
